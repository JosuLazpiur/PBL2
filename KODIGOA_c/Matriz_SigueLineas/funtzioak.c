...
void robota_funtzioak(int mapa[N_MAX][N_MAX], int* A, int* B, NODOA nodoen_lista[N_MAX * N_MAX], int tamaina_mapa_x, int tamaina_mapa_y, int tamaina_n, int ibilbidea[N_MAX], int S[N_MAX][N_MAX], NODOA Nodoen_m[N_MAX][N_MAX], int Nodoak[N_MAX][N_MAX], int ibilbidea_giroekin[N_MAX], int x, int y)
{
    ...
    ibilbidea[0] = *A;
    ibilbidea_kalk(S, *A, *B, ibilbidea, tamaina_n);

    printf_ibilbidea(ibilbidea);

    printf_kotxearen_pausuak(Nodoen_m, Nodoak, ibilbidea, ibilbidea_giroekin, nodoen_lista);
    ...
    else
    {
...

        {
            ...
            case ATZERA: //atzera
                ...
                printf("\n=======================222222222222==========================\n");
                eskuinera_tanke_while(t_aurrera);
                eskuinera_tanke_while(t_aurrera);
                break;
...
void nodoak_funtzioak(int mapa[N_MAX][N_MAX], int F[N_MAX][N_MAX], int Nodoak[N_MAX][N_MAX], int* tamaina_n, int* x, int* y, NODOA Nodoen_m[N_MAX][N_MAX], int tamaina_mapa_x, int tamaina_mapa_y, NODOA nodoen_lista[N_MAX * N_MAX]) 
{
    int nodo_kop = 0;
